...
GOOGLE_API_KEY = "AsbvvAIzdCaSyCFZRSGVAscaaadscdscWFTx5a56l9qhe194ROa6xDVsdvDcCfuVvagrw3ozw"
#genai.configure(api_key=os.getenv("GOOGLE_API_KEY"))
genai.configure(api_key=GOOGLE_API_KEY)


#prompt-> Tells what does model need to do
...
input_prompt1 = """
 You are an experienced Technical Human Resource with Tech Experience in the field of Data Science, Full Stack web development,
...
Big Data Engineering, Devops, Data Analyst and ATS functionality, your task is to evaluate the resume against the provided job description.
